...
func LoadConfig(cfg string) *Config {
	...
	config := &Config{
		...
		OpenaiModel:                getViperStringValue("OPENAI_MODEL", "fastchat-t5-3b-v1.0"),
		OpenAIHttpClientTimeOut:    getViperIntValue("OPENAI_HTTP_CLIENT_TIMEOUT", 30000),
		...
		OpenaiApiUrl:               getViperStringValue("API_URL", "http://172.22.72.170:8080"),
